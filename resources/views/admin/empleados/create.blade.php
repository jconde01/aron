  ...
  <div class="main main-raised">
    <div>
      ...
      <div class="section text-center">
        ...
        <form method="POST" action=" {{url('/admin/empleados')}} " enctype="multipart/form-data"> 
           {{ csrf_field() }}
          <div class="" style="">
            ...
            <div class="row">
                    ...
                    <div class="col-md-4 no-pad">
                        <div class="content-descripcion-left-input" style="margin-bottom: 2em;">
                            ...
                            <input type="text" name="NOMBRES" id="NOMBRES" onkeyup="fAgrega1();" maxlength="27">
                        </div> 
                    </div>
                    ...
                    <div class="col-md-4 no-pad">
                        <div class="content-descripcion-left-input" style="margin-bottom: 2em;">
                            ...
                            <input type="text" name="PATERNO" id="PATERNO" onkeyup="fAgrega1();" maxlength="27">
                        </div> 
                    </div>
                    ...
                    <div class="col-md-4 no-pad">
                        <div class="content-descripcion-left-input" style="margin-bottom: 2em;">
                            ...
                            <input type="text" name="MATERNO" id="MATERNO" onkeyup="fAgrega1();" maxlength="27">
                        </div> 
                    </div>
                    ...
                    <div class="col-md-4 no-pad">
                        <div class="content-descripcion-left-input" style="margin-bottom: 2em;">
                            ...
                            <select style="width: 340px; height: 40px; border-radius: 10px; text-align: right; padding-right: 20px;" name="PUESTO">
                                <option active value=" ">Puesto</option>
                                @foreach ($jobs as $job)
                    ...
                    <div class="col-md-4 no-pad">
                        <div class="content-descripcion-left-input" style="margin-bottom: 2em;">
                            ...
                            <select style="width: 340px; height: 40px; border-radius: 10px; text-align: right; padding-right: 20px;" name="DEPTO" required>
                                <option active value=" ">Departamento</option>
                                @foreach ($deps as $dep)
                    ...
                    <div class="col-md-4 no-pad" style="">
                        <div class="content-descripcion-left-input" style="margin-bottom: 2em;">
                            ...
                            <select style="width: 340px; height: 40px; border-radius: 10px; text-align: right; padding-right: 20px;" name="TIPOTRA">
                    ...
                    <div class="col-md-4 no-pad">
                        <div class="content-descripcion-left-input" style="margin-bottom: 2em;">
                            ...
                            <select style="width: 340px; height: 40px; border-radius: 10px; text-align: right; padding-right: 20px;" name="c_Estado" required>
                                <option active value=" ">Estado</option>
                                @foreach ($ests as $est)
                     ...
                     <div class="col-md-4 no-pad" style="">
                        <div class="content-descripcion-left-input" style="margin-bottom: 2em;">
                            ...
                            <select style="width: 340px; height: 40px; border-radius: 10px; text-align: right; padding-right: 20px;" name="DIRIND">
                    ...
                    <div class="col-md-4 no-pad">
                        <div class="content-descripcion-left-input" style="margin-bottom: 2em;">
                            <div class="label-left"><p>Tipo de Jornada</p></div>
                              <select style="width: 340px; height: 40px; border-radius: 10px; text-align: right; padding-right: 20px;" name="TIPOJORNADA">
                    ...
                    <div class="col-md-4 no-pad">
                        <div class="content-descripcion-left-input" style="margin-bottom: 2em;">
                            <div class="label-left"><p>Tipo de Regimen</p></div>
                             <select style="width: 340px; height: 40px; border-radius: 10px; text-align: right; padding-right: 20px;" name="TIPOREGIMEN">
                    ...
                    <div class="col-md-4 no-pad" style="">
                     ...
                     <div class="col-md-4 no-pad">
                        <div class="content-descripcion-left-input" style="margin-bottom: 2em;">
                            ...
                            <select style="width: 340px; height: 40px; border-radius: 10px; text-align: right; padding-right: 20px;" name="TURNO">
                     ...
                     <div class="col-md-4 no-pad">
                        <div class="content-descripcion-left-input" style="margin-bottom: 2em;">
                            ...
                            <input type="number" name="ZONAECO" value="">
                        </div> 
                    </div>
                     ...
                     <div class="col-md-4 no-pad" style="">
                        <div class="content-descripcion-left-input" style="margin-bottom: 2em;">
                            ...
                            <select style="width: 340px; height: 40px; border-radius: 10px; text-align: right; padding-right: 20px;" name="ESTATUS">
                                <option value="A">Activo</option>
                                <option value="B">Baja</option>
                                <option value="M">Vacaciones</option>
                     ...
                     <div class="col-md-4 no-pad" style="">
                        <div class="content-descripcion-left-input" style="margin-bottom: 2em;">
                            ...
                            <select style="width: 340px; height: 40px; border-radius: 10px; text-align: right; padding-right: 20px;" name="TIPOPAGO" required>
                     ...
                     <div class="col-md-4 no-pad" style="">
                        <div class="content-descripcion-left-input" style="margin-bottom: 2em;">
                            ...
                            <select style="width: 340px; height: 40px; border-radius: 10px; text-align: right; padding-right: 20px;" name="c_TipoContrato" required>
                    ...
                    <div class="col-md-4 no-pad">
                        <div class="content-descripcion-left-input" style="margin-bottom: 2em;">
                            ...
                            <input type="date" name="BAJA" value=" ">
                        </div> 
                    </div>
              ...
              <div id="nomina2" class="tab-pane fade" style="">
                    ...
                    <div class="col-md-4 no-pad">
                        <div class="content-descripcion-left-input" style="margin-bottom: 2em;">
                            ...
                            <input type="text" name="RFC" maxlength="15" onkeyup="Rfc(event, this)">
                        </div> 
                    </div>
                    ...
                    <div class="col-md-4 no-pad" style="border-bottom: 2px #F0F0F0 solid;">
                        <div class="content-descripcion-left-input" style="margin-bottom: 2em;">
                            ...
                            <select style="width: 340px; height: 40px; border-radius: 10px; text-align: right; padding-right: 20px;" name="GRUIMS">
                    ...
                    <div class="col-md-4 no-pad" style="border-bottom: 2px #F0F0F0 solid;">
                        <div class="content-descripcion-left-input" style="margin-bottom: 2em;">
                            ...
                            <input type="number" name="FONACOT" max="999999999999999" value=" ">
                        </div> 
                    </div>
                    ...
                    <div class="col-md-4 no-pad" style="border-bottom: 2px #F0F0F0 solid;">
                        <div class="content-descripcion-left-input" style="margin-bottom: 2em;">
                            ...
                            <input type="number" name="INFONAVIT" max="999999999999999" value=" ">
                        </div> 
                    </div>
                    ...
                    <div class="col-md-4 no-pad">
                        <div class="content-descripcion-left-input" style="margin-bottom: 2em;">
                            ...
                            <input type="number" name="SAROTR" max="999999999" value=" ">
                        </div> 
                    </div>
                    ...
                    <div class="col-md-4 no-pad">
                        <div class="content-descripcion-left-input" style="margin-bottom: 2em;">
                            ...
                            <input type="number" name="SUELDO" max="999999999">
                        </div> 
                    </div>
                    ...
                    <div class="col-md-4 no-pad">
                        <div class="content-descripcion-left-input" style="margin-bottom: 2em;">
                            ...
                            <input type="text" name="VARIMSS" max="999999999" value="0">
                        </div> 
                    </div>
                    ...
                    <div class="col-md-4 no-pad">
                        <div class="content-descripcion-left-input" style="margin-bottom: 2em;">
                            ...
                            <input type="number" name="INTEG" max="999999999">
                        </div> 
                    </div>
                    ...
                    <div class="col-md-4 no-pad">
                        <div class="content-descripcion-left-input" style="margin-bottom: 2em;">
                            ...
                            <input type="number" name="INTIV" max="999999999">
                        </div> 
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 no-pad">
                        <div class="content-descripcion-left-input" style="margin-bottom: 2em;">
                            ...
                            <select style="width: 340px; height: 40px; border-radius: 10px; text-align: right; padding-right: 20px;" name="REPORTA">
                                <option active value=" ">Categoria</option>
                                @foreach ($jobs as $job)
                                <option value="{{$job->PUESTO}}">{{$job->NOMBRE}}</option>
                    ...
                    <div class="col-md-4 no-pad">
                        <div class="content-descripcion-left-input" style="margin-bottom: 2em;">
                            ...
                            <input type="number" name="noExterior" max="9999" value=" ">
                        </div> 
                    </div>
                    ...
                    <div class="col-md-4 no-pad">
                        <div class="content-descripcion-left-input" style="margin-bottom: 2em;">
                            ...
                            <input type="number" name="noInterior" max="9999" value=" ">
                        </div> 
                    </div>
                    ...
                    <div class="col-md-4 no-pad">
                        <div class="content-descripcion-left-input" style="margin-bottom: 2em;">
                            ...
                            <input type="text" name="Municipio" maxlength="150" value=" ">
                        </div> 
                    </div>
                    ...
                    <div class="col-md-4 no-pad">
                        <div class="content-descripcion-left-input" style="margin-bottom: 2em;">
                            ...
                            <input type="text" name="COLONIA" maxlength="40" value=" ">
                        </div> 
                    </div>
                    ...
                    <div class="col-md-4 no-pad">
                        <div class="content-descripcion-left-input" style="margin-bottom: 2em;">
                            <div class="label-left"><p>Estado:</p></div>
                            <input type="text" name="ESTADO" maxlength="20" value=" ">
                        </div> 
                    </div>
                    ...
                    <div class="col-md-4 no-pad">
                        <div class="content-descripcion-left-input" style="margin-bottom: 2em;">
                            ...
                            <input type="number" name="TELEFONO" max="9999999999999" value=" ">
                        </div> 
                    </div>
                    ...
                    <div class="col-md-4 no-pad">
                        <div class="content-descripcion-left-input" style="margin-bottom: 2em;">
                            ...
                            <input type="number" name="ZIP" max="99999999999" value=" ">
                        </div> 
                    </div>
                    ...
                    <div class="col-md-4 no-pad">
                        <div class="content-descripcion-left-input" style="margin-bottom: 2em;">
                            ...
                            <input type="NUMBER" name="CELULAR" max="999999999999999" value=" ">
                        </div> 
                    </div>
                    ...
                    <div class="col-md-4 no-pad">
                        <div class="content-descripcion-left-input" style="margin-bottom: 2em;">
                            ...
                            <select style="width: 340px; height: 40px; border-radius: 10px; text-align: right; padding-right: 20px;" name="CIVIL">
                    ...
                    <div class="col-md-4 no-pad">
                        <div class="content-descripcion-left-input" style="margin-bottom: 2em;">
                            ...
                            <select style="width: 340px; height: 40px; border-radius: 10px; text-align: right; padding-right: 20px;" name="LICENCIA">
                    ...
                    <div class="col-md-4 no-pad">
                        <div class="content-descripcion-left-input" style="margin-bottom: 2em;">
                            ...
                            <select style="width: 340px; height: 40px; border-radius: 10px; text-align: right; padding-right: 20px;" name="SANGRE">
                    ...
                    <div class="col-md-4 no-pad">
                        <div class="content-descripcion-left-input" style="margin-bottom: 2em;">
                            ...
                            <select style="width: 340px; height: 40px; border-radius: 10px; text-align: right; padding-right: 20px;" name="ESCOLAR">
                    ...
                    <div class="col-md-4 no-pad">
                        <div class="content-descripcion-left-input" style="margin-bottom: 2em;">
                            ...
                            <input type="text" name="NACIM" maxlength="15" value=" ">
                        </div> 
                    </div>
                    ...
                    <div class="col-md-4 no-pad">
                        <div class="content-descripcion-left-input" style="margin-bottom: 2em;">
                            ...
                            <select style="width: 340px; height: 40px; border-radius: 10px; text-align: right; padding-right: 20px;" name="NACIONAL">
                    ...
                    <div class="col-md-4 no-pad">
                        <div class="content-descripcion-left-input" style="margin-bottom: 2em;">
                            ...
                            <select style="width: 340px; height: 40px; border-radius: 10px; text-align: right; padding-right: 20px;" name="MEDIO">
              ...
              <div id="datosa" class="tab-pane fade">
                <div class="row">
                    <div class="col-md-4 no-pad">
                        <div class="content-descripcion-left-input" style="margin-bottom: 2em;">
                            <div class="label-left"><p>Nombre: </p></div>
                            <input type="text" id="nombre3"  class="bloqueado">
                        </div> 
                    </div>
                    ...
                    <div class="col-md-4 no-pad">
                        <div class="content-descripcion-left-input" style="margin-bottom: 2em;">
                            ...
                            <input type="text" name="PADRE" maxlength="30" value=" ">
                        </div> 
                    </div>
                    ...
                    <div class="col-md-4 no-pad">
                        <div class="content-descripcion-left-input" style="margin-bottom: 2em;">
                            ...
                            <input type="text" name="MADRE" maxlength="30" value=" ">
                        </div> 
                    </div>
...
function fAgrega()
{
document.getElementById("nombre3").value = document.getElementById("PATERNO").value;
}
</script> -->
<script language="javascript">
function fAgrega1()
