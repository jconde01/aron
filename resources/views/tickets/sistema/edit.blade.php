  ...
  <div class="main main-raised"> 
    <div class="container">
      ...
      <div class="section text-center">
        <h2 class="titulo">Seguimiento del Ticket</h2> <br>
          ...
          <div class="row" style="border: 1px red solid; max-width: 700px; margin: auto!important;"> 
                     ...
                     <div class="col-md-6 col-md-offset-3" style="">
                        <div class="content-descripcion-left-input" style="margin-bottom: 2em; ">
                            ...
                            <select style="width: 300px; height: 40px; border-radius: 10px; text-align: right; " name="clasificacion" class="inderecha">
                    ...
                    <div class="col-md-6 col-md-offset-3" style="">
                        <div>
                            <textarea rows="4" cols="40" name="comentarios" placeholder="Comentarios."> {{$ticket->comentarios}}</textarea>
                        </div> 
                    </div>
                    ...
                    <div class="col-md-6 col-md-offset-3" style="">
                        <div>
                            <textarea rows="4" cols="40" name="solucion" placeholder="Describe brevemente la solución. (El ticktet permanecera abierto hasta que se le proporcione una solución.)"></textarea>
                        </div> 
                    </div>
            ...
            <br>
            <button class="grande" style="font-size: 15px;">Actualizar o Cerrar</button>
            &nbsp;
            <a href="{{url('/tickets/sistema/aceptado')}}" class="primario1" style="padding: 14px!important;">Regresar</a>   
        </form>
