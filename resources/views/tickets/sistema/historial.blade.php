  ...
  <div class="main main-raised"> 
    <div class="container">
      ...
      <div class="section text-center">
        <h2 class="titulo">Historial de Tickets</h2> <br>
            ...
            <table id="table_id" class="display">      
                       <thead>
                        <tr>
                            ...
                            <th class="parrafo">Consultar Ticket</th>
                        </tr> 
                       </thead> 
                       ...
                       <tbody>
                        ...
                        <tr> 
                            ...
                            <td class="parrafo"><a href="{{url('/tickets/sistema/'.$ticket->folio.'/ver')}}" rel="tooltip" title="Consultar"><i class="fas fa-arrow-alt-circle-right"></i></a></td>    
                        </tr> @endforeach
                      </tbody>
