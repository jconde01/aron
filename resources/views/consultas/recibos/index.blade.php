            ...
            <table id="table_id" class="display"> 
                    ...
                    <tbody>@foreach ($emps as $emp)
                        <tr>
                            ...
                            <td class="parrafo"><a href="{{url('/consultas/recibos/'.$emp->EMP.'/consulta')}}" rel="tooltip" title="Consultar" class="btn btn-success btn-simple btn-xs"><i class="far fa-file-pdf"></i></a></td>             
                        </tr>  @endforeach 
                    </tbody>
