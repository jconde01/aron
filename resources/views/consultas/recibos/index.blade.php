...
<div class="main main-raised"> 
    <div class="container">   
      <div class="section text-center">
        <h2 class="titulo">Recibos de Empleados</h2>
            ...
            <table id="table_id" class="display"> 
                    ...
                    <tbody>@foreach ($emps as $emp)
                        <tr>
                            ...
                            <td class="parrafo"><a href="{{url('/consultas/recibos/'.$emp->RFC.'/consulta')}}" rel="tooltip" title="Consultar" class="btn btn-success btn-simple btn-xs"><i class="far fa-file-pdf"></i></a></td>             
                        </tr>  @endforeach 
                    </tbody>
