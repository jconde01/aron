...
//---------------------------------------------------------------------------------------------
// Rutas de puestos
// Route::get('/admin/puestos', 'PuestosController@index'); //listado
// Route::get('/admin/puestos/create', 'PuestosController@create'); //crear productos
// Route::post('/admin/puestos', 'PuestosController@store');
// //rutas para actulizar la info puestos
// Route::get('/admin/puestos/{PUESTO}/edit', 'PuestosController@edit'); //formulario de edicion
// Route::post('/admin/puestos/{PUESTO}/edit', 'PuestosController@update');//actulizarl
//---------------------------------------------------------------------------------------------


//---------------------------------------------------------------------------------------------
//RUTAS DE EMPLEADOS
// Route::get('/admin/empleados', 'EmpleadosController@index');
// Route::get('/admin/empleados/create', 'EmpleadosController@create');
// Route::post('/admin/empleados', 'EmpleadosController@store');
// //actualizar info deptos
// Route::get('/admin/empleados/{EMP}/edit', 'EmpleadosController@edit');
// Route::post('/admin/empleados/{EMP}/edit', 'EmpleadosController@update');
