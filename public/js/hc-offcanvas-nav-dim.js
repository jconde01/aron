    ...
    _.fn.extend({
        hcOffcanvasNav: function() {
            ...
            return this.each(function() {
                            ...
                            u = function c(n) {
                                ...
                                return n.each(function() {
                                    ...
                                    n.children("li").each(function() {
                                        var n = _(this),
                                            e = n.children(":not(ul):not(div)").add(n.contents().filter(function() {
                                    ...
                                    if (t && o.prepend("<h2>".concat(t, "</h2>")), _.each(n, function(n, e) {
                                            ...
                                            _.each(e.items, function(n, e) {
                                                var t = e.$content,
                                                    ...
                                                    o = a.length ? a.clone() : _("<a>").append(t.clone()).on("click", G);
                                                a.length && o.on("click", function(n) {
                                                    n.stopPropagation(), a[0].click()
                                                }), "#" === o.attr("href") && o.on("click", function(n) {
                                                    n.preventDefault()
                                                }), H.closeOnClick && (!1 === H.levelOpen || "none" === H.levelOpen ? o.on("click", j) : o.filter(function() {
                                                    var n = _(this);
                                                ...
                                                if (e.subnav.length) {
                                                    var s = m + 1,
                                                        l = e.uniqid,
                                                        r = "";
                                                    if (C[s] || (C[s] = 0), c.addClass("nav-parent"), !1 !== H.levelOpen && "none" !== H.levelOpen) {
                                                        var p = C[s],
                ...
                function N() {
                    if (h = !0, d.css("visibility", "visible").addClass($), s.addClass("toggle-open"), "expand" === H.levelOpen && x && clearTimeout(x), H.disableBody && (m = Q.scrollTop() || D.scrollTop(), L.documentElement.scrollHeight > L.documentElement.clientHeight && Q.addClass("hc-nav-yscroll"), D.addClass("hc-nav-open"), m && D.css("top", -m)), f) {
                ...
                function j() {
                    h = !1, f && R(f, 0), d.removeClass($), v.removeAttr("style"), s.removeClass("toggle-open"), "expand" === H.levelOpen && -1 !== ["top", "bottom"].indexOf(H.position) ? W(0) : !1 !== H.levelOpen && "none" !== H.levelOpen && (x = setTimeout(function() {
                        W(0)
